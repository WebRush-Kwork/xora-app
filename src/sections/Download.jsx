...
const Download = () => {
	return (
		<section>
			<Element
				name='download'
				className='relative g7 pb-32 pt-24 max-lg:pb-24 max-md:py-16'
			>
				<div className='container'>
					<div className='flex items-center'>
						...
						<div className='mb-10 max-md:hidden'>
							<div className='download_preview-before download_preview-after rounded-40 relative w-[965px] border-2 border-s5 p-6'>
					...
					<ul className='flex justify-center mt-24 max-lg:hidden'>
						{logos.map(({ id, width, height, url, title }) => (
